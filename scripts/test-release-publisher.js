...
assert.strictEqual((workflow.match(/tr -d '\\\\r' < release-artifacts\/SHA256SUMS\.txt/g)||[]).length, 2, 'Both Linux checksum readers must normalize Windows CRLF line endings.');
